...
def encrypt_image(image_path, output_path, key):
    ...
    for _ in range(100):  # Perform multiple swaps for better encryption
...
def decrypt_image(encrypted_path, output_path, key):
    ...
    # Reverse the pixel swapping (not implemented; need to store swap info)
    # Here, you might want to implement a way to reverse the swaps
